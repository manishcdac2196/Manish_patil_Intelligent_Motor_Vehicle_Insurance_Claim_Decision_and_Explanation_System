...
1.  **Configure Database**:
    Ensure your local PostgreSQL is running. The default connection string in `start-project.ps1` is:
    `postgresql://postgresql:abhishekc1@localhost:5432/motor_insurance_db`
    (Edit the script or set `DATABASE_URL` env var if yours differs)
